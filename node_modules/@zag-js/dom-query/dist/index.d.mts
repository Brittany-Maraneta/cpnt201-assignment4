...
export { type ItemToId, MAX_Z_INDEX, type OverflowAncestor, type ScopeContext, type ScrollOptions, type ScrollPosition, type TypeaheadOptions, type TypeaheadState, ariaAttr, contains, createScope, dataAttr, defaultItemToId, getActiveElement, getBeforeInputValue, getByText, getByTypeahead, getComputedStyle, getDocument, getDocumentElement, getEventTarget, getNearestOverflowAncestor, getNodeName, getOverflowAncestors, getParentNode, getPlatform, getScrollPosition, getWindow, indexOfId, isApple, isDocument, isDom, isEditableElement, isFirefox, isHTMLElement, isHiddenElement, isInView, isIos, isMac, isNode, isOverflowElement, isRootElement, isSafari, isSelfEvent, isShadowRoot, isTouchDevice, isVisualViewport, isWebKit, isWindow, itemById, nextById, nextTick, prevById, query, queryAll, raf, scrollIntoView };
